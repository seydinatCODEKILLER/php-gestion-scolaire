<div class="flex justify-between items-center px-4 py-2 bg-white">
    ...
    <p class="px-3 py-1 rounded-3xl bg-orange-100 text-orange-500 font-medium hidden lg:block"><?= $contenue ?></p>
    <div class="flex items-center gap-4">
        <div class="flex flex-col">
            <span class="text-sm text-end text-orange-500 font-medium"><?= getDataFromSession("user", "libelle") ?></span>
