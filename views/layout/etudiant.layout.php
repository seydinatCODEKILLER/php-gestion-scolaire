...
<body class="flex items-center h-screen inset-0 bg-gradient-to-r from-indigo-50/50 to-white">
    <?php require_once ROOT_PATH . "/components/sidebar/sidebarEtudiant.php"; ?>
    <div class="w-full flex flex-col lg:ml-56 h-full">
        <?php require_once ROOT_PATH . "/components/header/headerEtudiant.php"; ?>
        <?= $content ?>
    </div>
